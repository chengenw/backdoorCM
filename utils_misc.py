...
def img_sched(img_size=512, step=4):
    ...
    for i in steps:
        ...
        # plt.imshow(clean_image); plt.show()
        # plt.imshow(target_image); plt.show()
    # clean_images.append(noise)
    # target_images.append(noise)
...
def torch2hf():
    ...
    # model2 = MyModel.from_pretrained(hf_model, local_files_only=True)
    pass
